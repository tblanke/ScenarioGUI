...
class Translations:  # pragma: no cover
    ...
    def __init__(self):
        ...
        self.pushButton_SaveScenario: List[str] = ["Update scenario", "Szenario aktualisieren"]
        self.pushButton_AddScenario: List[str] = ["Add scenario", "Szenario hinzufügen"]
        self.pushButton_DeleteScenario: List[str] = ["Delete scenario", "Szenario löschen"]
        self.pushButton_start_multiple: List[str] = ["Calculate all scenarios", "Berechne alle Szenarios"]
        ...
        self.actionUpdate_Scenario: List[str] = ["Update scenario", "Szenario aktualisieren"]
        ...
        self.actionRename_scenario: List[str] = ["Rename scenario", "Szenario umbenennen"]
