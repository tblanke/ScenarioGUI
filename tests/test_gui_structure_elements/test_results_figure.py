...
def test_results_figure(qtbot):
    ...
    main_window.gui_structure.figure_results.option_font.set_value(0)
    ...
    assert not np.isclose(main_window.gui_structure.option_font.get_value()[0], 0)
    ...
    assert np.allclose(main_window.gui_structure.option_font.get_value()[0], 0)
