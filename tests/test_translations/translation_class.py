class Translations:  # pragma: no cover
	__slots__ = ('action_add_scenario', 'action_delete_scenario', 'action_new', 'action_open', 'action_rename_scenario', 'action_save', 'action_save_as', 'action_start_multiple', 'action_update_scenario', 'button_rename_scenario', 'Calculation_Finished', 'category_language', 'icon', 'label_abort', 'label_cancel', 'label_CancelText', 'label_CancelTitle', 'label_close', 'label_Language', 'label_Language_Head', 'label_LeaveScenario', 'label_LeaveScenarioText', 'label_New', 'label_new_scenario', 'label_next', 'label_okay', 'label_Open', 'label_previous', 'label_Save', 'label_Save_As', 'label_status', 'label_StayScenario', 'Load', 'menu_calculation', 'menu_file', 'menu_language', 'menu_scenario', 'menu_settings', 'new_name', 'no_backup_file', 'no_solution', 'not_calculated', 'option_language', 'page_result', 'page_settings', 'push_button_add_scenario', 'push_button_cancel', 'push_button_delete_scenario', 'push_button_save_scenario', 'push_button_start_multiple', 'Save', 'SaveFigure', 'scenarioString', 'short_cut', 'tool_imported', 'choose_load', 'option_toggle_buttons', 'no_file_selected', 'option_n_threads', 'cat_no_results', 'text_no_result', 'category_save_scenario', 'option_auto_saving', 'hint_saving', 'aim_add', 'aim_sub', 'languages')
	def __init__(self):
		...
		self.label_CancelText: list[str] = ['Are you sure you want to quit? Any unsaved work will be lost.', 'Bist du sicher das Programm zu schließen? Alle ungesicherten Änderungen gehen sonst verloren.']
		...
		self.label_LeaveScenarioText: list[str] = ['Are you sure you want to leave scenario? Any unsaved work will be lost.', 'Bist du sicher das Szenario zu verlasen? Alle ungesicherten Änderungen gehen sonst verloren.']
		...
		self.option_language: list[str] = ['Language:,English,German,Dutch,Italian,French,Spanish,Galician', 'Sprache:,English,German,Dutch,Italian,French,Spanish,Galician']
