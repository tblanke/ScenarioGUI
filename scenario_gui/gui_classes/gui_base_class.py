...
from ..global_settings import BLACK, DARK, FOLDER, FONT, FONT_SIZE, GREY, LIGHT, LIGHT_SELECT, WHITE
...
class BaseUI:
    ...
    def setup_ui(self, ghe_tool):
        ...
        icon1 = QtG.QIcon()
        icon1.addFile(f"{FOLDER}/gui/icons/New.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon1.addFile(f"{FOLDER}/gui/icons/New_Inv.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        self.actionNew.setIcon(icon1)
        self.actionSave = QtG.QAction(ghe_tool)
        self.actionSave.setObjectName("actionSave")
        self.actionSave.setEnabled(True)
        icon2 = QtG.QIcon()
        icon2.addFile(f"{FOLDER}/gui/icons/Save.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon2.addFile(f"{FOLDER}/gui/icons/Save_Inv.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        self.actionSave.setIcon(icon2)
        self.actionOpen = QtG.QAction(ghe_tool)
        self.actionOpen.setObjectName("actionOpen")
        self.actionOpen.setEnabled(True)
        icon3 = QtG.QIcon()
        icon3.addFile(f"{FOLDER}/gui/icons/Open.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon3.addFile(f"{FOLDER}/gui/icons/Open_Inv.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        ...
        icon4 = QtG.QIcon()
        icon4.addFile(f"{FOLDER}/gui/icons/Start_multiple_inv.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon4.addFile(f"{FOLDER}/gui/icons/Start_multiple.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        ...
        icon7 = QtG.QIcon()
        icon7.addFile(f"{FOLDER}/gui/icons/Update_Inv.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon7.addFile(f"{FOLDER}/gui/icons/Update.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        ...
        icon8 = QtG.QIcon()
        icon8.addFile(f"{FOLDER}/gui/icons/Add_Inv.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon8.addFile(f"{FOLDER}/gui/icons/Add.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        ...
        icon9 = QtG.QIcon()
        icon9.addFile(f"{FOLDER}/gui/icons/Delete_Inv.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon9.addFile(f"{FOLDER}/gui/icons/Delete.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        self.actionDelete_scenario.setIcon(icon9)
        self.actionSave_As = QtG.QAction(ghe_tool)
        self.actionSave_As.setObjectName("actionSave_As")
        icon10 = QtG.QIcon()
        icon10.addFile(f"{FOLDER}/gui/icons/SaveAs.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon10.addFile(f"{FOLDER}/gui/icons/Save_As_Inv.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        ...
        icon14 = QtG.QIcon()
        icon14.addFile(f"{FOLDER}/gui/icons/Rename_Inv.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon14.addFile(f"{FOLDER}/gui/icons/Rename.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        ...
        icon15 = QtG.QIcon()
        icon15.addFile(f"{FOLDER}/gui/icons/Start_inv.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon15.addFile(f"{FOLDER}/gui/icons/Start.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
        ...
        icon18 = QtG.QIcon()
        icon18.addFile(f"{FOLDER}/gui/icons/Update.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        ...
        icon19 = QtG.QIcon()
        icon19.addFile(f"{FOLDER}/gui/icons/Add.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        ...
        icon20 = QtG.QIcon()
        icon20.addFile(f"{FOLDER}/gui/icons/Delete.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        ...
        icon21 = QtG.QIcon()
        icon21.addFile(f"{FOLDER}/gui/icons/Rename.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        ...
        icon32 = QtG.QIcon()
        icon32.addFile(f"{FOLDER}/gui/icons/Start.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        ...
        icon33 = QtG.QIcon()
        icon33.addFile(f"{FOLDER}/gui/icons/Start_multiple.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        ...
        icon34 = QtG.QIcon()
        icon34.addFile(f"{FOLDER}/gui/icons/Exit.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        ...
        icon35 = QtG.QIcon()
        icon35.addFile(f"{FOLDER}/gui/icons/Language.svg", QtC.QSize(), QtG.QIcon.Normal, QtG.QIcon.Off)
        icon35.addFile(f"{FOLDER}/gui/icons/Language_Inv.svg", QtC.QSize(), QtG.QIcon.Active, QtG.QIcon.Off)
